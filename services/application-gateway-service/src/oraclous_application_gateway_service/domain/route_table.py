...
_ROUTES: tuple[tuple[str, str], ...] = (
    ...
    # knowledge-retriever (/v1/federated/* — the cross-graph federated reads, #330/ADR-026: the
    # retriever enumerates the caller's accessible set itself; the gateway only proxies)
